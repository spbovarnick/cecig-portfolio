  ...
  return (
    <section className="px-6 py-16 bg-[#E9E4E0]">
      ...
      <div className="grid grid-cols-1 gap-y-8 gap-x-10 lg:grid-cols-2 lg:w-[802px]">
        { inspo.map((cel) => (
          <div key={cel._key} className="max-w-[381px] min-h-20 max-h-fit border border-black rounded-[20px] px-4 py-2 flex items-center hover:bg-white ease-in duration-300">
