...
export default function Footer(){
  ...
  return (
    <div id="footer" className="box-border flex flex-col md:flex-row w-full md:justify-between md:items-center absolute bottom-0 p-6 md:p-0 md:h-[119px] leading-none text-2xl">
